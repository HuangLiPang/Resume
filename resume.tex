...
\inlineheadsection
  ...
  {Express, Leaflet, Mapbox, Reactjs, Material-UI, Docker, MongoDB, PostgreSQL, CassandraDB}
% \inlineheadsection
%   {Tools:}
    ...
    {\bodytext{
      \begin{itemize}
        \begin{description}
          ...
          \item [-] Constructed a data ingestion application for extract-transform-load sensor data to \textbf{OpenTSDB} and \textbf{PosgreSQL}.
        \end{description}
      \end{itemize}
    }}
}
