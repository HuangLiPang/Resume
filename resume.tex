...
\inlineheadsection
  {Languages:}
  {Python, Nodejs, JavaScript, C, C++, Java, Linux Bash}
  \vspace{0.3em}
\inlineheadsection
  {Frameworks:}
  {Expressjs, Leaflet, Mapbox, Reactjs, Nextjs}
  \vspace{0.3em}
\inlineheadsection
  {Tools and Severless:}
  {Docker, MongoDB, PostgreSQL, OpenTSDB, AWS, Heroku, Digital Ocean, Netlify, Vercel, MongoDB Atlas}
% \inlineheadsection
%   {Serverless:}
...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    ...
    {\bodytext{
      \begin{itemize}
        \begin{description}
          \item [-] Built a dashboard using \textbf{Reactjs} and \textbf{Material-UI} for visualizing time-series data and modifying metadata.
          \item [-] Developed an authentication API for accessing sensor data using \textbf{Express}, \textbf{AWS EC2}, \textbf{Cognito}, \textbf{API Gateway}, and \textbf{Lambda}.
          \item [-] Constructed a data ingestion application for extract-transform-load sensor data to \textbf{OpenTSDB} and \textbf{PostgreSQL}.
        \end{description}
      \end{itemize}
    }}
}
...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    ...
    {\bodytext{
      \begin{itemize}
        \begin{description}
          \item [-] Created a \href{https://stacspec.org/}{STAC} data model for imagery metadata from \href{https://www.fsa.usda.gov/programs-and-services/aerial-photography/imagery-programs/naip-imagery/}{NAIP} using \textbf{Python Pydantic}.
          \item [-] Developed a CLI tool using \textbf{Python Click} to process extract-transform-load of 851,000+ imagery metadata to the STAC API.
          \item [-] Enhanced the CLI tool with the feature to re-ingest the imagery from error messages.
          \item [-] Built a web application for searching and visualizing NAIP imagery on the map using \textbf{Reactjs} and \textbf{Material-UI}.
        \end{description}
      \end{itemize}
    }}
}
    ...
    {\bodytext{
      ...
      \begin{itemize}
        \item \textbf{PM2.5 Data Visualization} (PM2.5 is an air pollution particle.)
          \begin{description}
          \item [-] Developed \href{https://pm25.lass-net.org/GIS/IDW/}{Inverse Distance Weighting (IDW) Map} and \href{https://pm25.lass-net.org/GIS/voronoi/}{Voronoi Map} using \textbf{Mapbox} and \textbf{Leaflet}.
        ...
        \begin{description}
          \item [-] Reduced at least 720 queries per day by optimizing the IDW map snapshot process using \textbf{Python}.
...
\headedsection  % sets the header for the section and includes any subsections
  ...
  \headedsubsection
    ...
    {\bodytext{
      \begin{itemize}
        \item \textbf{Fleet Position Web Application}
        \begin{description}
          ...
          \item [-] Integrated the route information with weather data from \textbf{Windy API} which speeds up the analysis of fleet route.
        ...
        \end{description}
        \item \href{https://line.me/R/ti/p/@vqv6210u}{\textbf{Line Bot Fleet Position Echoer}}
        \begin{description}
          \item [-] Created a chatbot in Line application using \textbf{line-bot-sdk-nodejs}.
...
\roottitle{\href{https://github.com/HuangLiPang/HuangLiPang/blob/master/Projects.md}{Projects}}

\vspace{0.2em}
\headedsection
  {{\textbf{Privacy Policy on \href{https://github.com/nabeeln7/on-the-edge}{Distributed IoT Platform}}}}
  {\bodytext{
  \begin{itemize}
    \item Designed mechanisms for handling application management using \textbf{Nodejs}, \textbf{Express}, \textbf{MQTT}, \textbf{child\_process}, etc.
    \item Implemented methods for enforcing data privacy policy using \textbf{cron-parser library}.
  \end{itemize}}
}
...
\headedsection
  ...
  {\bodytext{
  \begin{itemize}
    \item Created an application that can let user search words from a dictionary with more than 2 million words in a few milliseconds.
    \item Hosted the serverless application on \textbf{Heroku} and \textbf{Mongodb Atlas}.
    \item Fine-tuned Mongodb using \textbf{Text Indexes}.
  \end{itemize}}
}
